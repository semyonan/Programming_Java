...
import com.lab.dto.MessageResponse;
import com.lab.dto.UserInfoResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        messagePublisher.sendCarModelAccessMessage(Long.parseLong(userDetails.getUsername()));
        messagePublisher.sendEngineAccessMessage(Long.parseLong(userDetails.getUsername()));
