...
import mybatis.dao.CarMarkDaoImpl;
import mybatis.dao.CarModelDaoImpl;
...
public class MybatisTest {
    ...
    public static void init() throws SQLException, IOException {
        ...
        carMarkDao = new CarMarkDaoImpl(sessionFactory);
        carModelDao = new CarModelDaoImpl(sessionFactory);
    }
    @Test
